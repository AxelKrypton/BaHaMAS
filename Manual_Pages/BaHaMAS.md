% BaHaMAS(1) Version 0.5.0 | General User Manual
% Alessandro Sciarra
% 18 December 2025
...
A more detailed general overview is available [online](https://github.com/AxelKrypton/BaHaMAS/wiki).
...
:   Running `BaHaMAS` in most modes relies on a local configuration file, which name must be `betas`.
    Refer to [its dedicated section](https://github.com/AxelKrypton/BaHaMAS/wiki/Getting-started#the-betas-file) in the Wiki for more information.
...
The [online Wiki](https://github.com/AxelKrypton/BaHaMAS/wiki) contains the full documentation.
